...
init -1 python hide:
    ...
    style.default.outlines = [ (2, "#363636", 0, 0),  (1, "#000000", 0, 0) ]
    ...
    config.main_menu_music = "title.ogg"
    ...
    ##   'init'.)
python early:
    config.save_directory = "FateStayNight-1416880414"
...
init python:
    ...
    build.directory_name = "FateStayNight-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "FateStayNight"
